...
conn_str='DATABASE=bludb;HOSTNAME=b0aebb68-94fa-46ec-a1fc-1c999edb6187.c3n41cmd0nqnrk39u98g.databases.appdomain.cloud;PORT=31249;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=lyj19879;PWD=65OFsZtEsJX9MBxm'
...
def admin():
   if request.method == 'POST':
      if(request.form['email']=="admin@famms.com"):
